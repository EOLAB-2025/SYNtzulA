...
set chipH  2230; # left/right (height)
set chipW  2285; # top/bottom (width)
...
place_pad -row IO_EAST  -location [expr $offset  + 14*($width + $space_between_pad)]                 "pad_buttons_2" ; 
place_pad -row IO_EAST  -location [expr $offset  + 13*($width + $space_between_pad)]                 "pad_buttons_1" ; 
place_pad -row IO_EAST  -location [expr $offset  + 12*($width + $space_between_pad)]                 "pad_buttons_0" ; 
place_pad -row IO_EAST  -location [expr $offset  + 11*($width + $space_between_pad)]                 "pad_i_flash_miso" ; 
place_pad -row IO_EAST  -location [expr $offset  + 10*($width + $space_between_pad)]                  "pad_o_flash_ss" ; 
place_pad -row IO_EAST  -location [expr $offset  + 9*($width + $space_between_pad)]                  "pad_o_flash_sck" ; 
place_pad -row IO_EAST  -location [expr $offset  + 8*($width + $space_between_pad)]                  "pad_o_flash_mosi" ;

place_pad -row IO_EAST  -location [expr $offset  + 7*($width + $space_between_pad)]                  "pad_uart_rx" ; 
place_pad -row IO_EAST  -location [expr $offset  + 6*($width + $space_between_pad)]                  "pad_wb_clk" ; 
place_pad -row IO_EAST  -location [expr $offset  + 5*($width + $space_between_pad)]                  "pad_wb_rst" ;
place_pad -row IO_EAST  -location [expr $offset  + 4*($width + $space_between_pad)]                  "pad_timer_clk" ; 
place_pad -row IO_EAST  -location [expr $offset  + 3*($width + $space_between_pad)]                  "pad_o_txd" ; 
place_pad -row IO_EAST  -location [expr $offset  + 2*($width + $space_between_pad)]                 "pad_enb_debug" ; 
place_pad -row IO_EAST  -location [expr $offset  + 1*($width + $space_between_pad)]                 "pad_output_buffer_wr_en_debug" ;
